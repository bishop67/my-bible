  ...
  return (
    <div className="min-h-screen bg-[var(--paper)] text-stone-900">
      ...
      <section id="verse-of-the-day" className="mx-auto max-w-4xl scroll-mt-4 px-8 pt-14 md:pt-16">
        <h2 className="flex items-baseline gap-3 border-b border-stone-300 pb-2 font-display text-2xl text-[#3b2416] [font-variant-caps:small-caps]">
          Verse of the Day
          <span className="font-serif text-base text-stone-500 italic [font-variant-caps:normal]">for {verse.date}</span>
        </h2>
        <figure className="mx-auto max-w-3xl py-10 text-center">
          ...
          <blockquote className="font-serif text-3xl leading-snug text-balance text-[#3b2416] md:text-4xl">
            &ldquo;{verse.text}&rdquo;
          </blockquote>
          <figcaption className="mt-5">
            <Link
              href={`/read/${verse.slug}/${verse.chapter}#v${verse.verse}`}
              className="font-display text-lg tracking-wide text-[#8a5a2b] [font-variant-caps:small-caps] hover:text-[#3b2416] hover:underline hover:underline-offset-4"
            >
