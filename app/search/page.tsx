  ...
  return (
    <div className="min-h-screen bg-[var(--paper)] text-stone-900">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="border-b border-stone-300 pb-2 font-display text-3xl text-[#4a3726] [font-variant-caps:small-caps]">
          ...
          {hits.map((h) => (
            <li key={`${h.slug}-${h.chapter}-${h.verse}`}>
              <Link
                ...
                className="font-display text-lg text-[#8a6a48] [font-variant-caps:small-caps] hover:text-[#4a3726] hover:underline hover:underline-offset-4"
              >
