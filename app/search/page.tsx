  ...
  return (
    <div className="min-h-screen bg-[var(--paper)] text-stone-900">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="border-b border-stone-300 pb-2 font-display text-3xl text-[#2b2621] [font-variant-caps:small-caps]">
          ...
          {hits.map((h) => (
            <li key={`${h.slug}-${h.chapter}-${h.verse}`}>
              <Link
                ...
                className="font-display text-lg text-[#6b6259] [font-variant-caps:small-caps] hover:text-[#2b2621] hover:underline hover:underline-offset-4"
              >
